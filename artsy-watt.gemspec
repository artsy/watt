...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Watt is a shared asset library for Artsy PE rails apps'
  spec.summary       = 'Watt is a shared asset library for Artsy PE rails apps'
  ...
  spec.add_dependency 'neat', '~> 1.5.1'
